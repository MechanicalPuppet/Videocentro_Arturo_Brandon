 ...
 * @author R2
 */
@WebServlet(name = "obtenClienteEliminar", urlPatterns = {"/obtenClienteEliminar"})
public class obtenClienteEliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Cliente> lista = crud.consultarClientes();

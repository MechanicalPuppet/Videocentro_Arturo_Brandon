 ...
 * @author R2
 */
@WebServlet(name = "obtenVideojuegoInventarear", urlPatterns = {"/obtenVideojuegoInventarear"})
public class obtenVideojuegoInventarear extends HttpServlet {
            ...
            for (Videojuego juego : lista) {
                ...
                if(juego.getNumCatalogo().equalsIgnoreCase(videojuego.getNumCatalogo())){
                  ...
                  request.getSession().setAttribute("version", juego.getVersion());
                   ...
                   response.sendRedirect("capturaInventarearVideojuego.jsp");

...
CREATE TABLE `rentasvideojuegos` (
  ...
  `tiempoRenta` int(11) NOT NULL,
  PRIMARY KEY (`numCredencial`,`numCatalogo`),
  KEY `numCatalogo_idx` (`numCatalogo`),
  CONSTRAINT `numCatalogo` FOREIGN KEY (`numCatalogo`) REFERENCES `videojuegos` (`numCatalogo`),
  CONSTRAINT `numCredencial` FOREIGN KEY (`numCredencial`) REFERENCES `clientes` (`numCredencial`)
...
-- Dump completed on 2020-12-04 20:41:01
